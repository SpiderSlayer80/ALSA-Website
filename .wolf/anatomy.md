...
- `App.jsx` — ROOT COMPONENT — assembles every section of the page in order. (~757 tok)
- `main.jsx` — ENTRY POINT — this is the first file that runs. (~168 tok)
...
- `ToastContext.jsx` — ToastContext — uses useContext, useState, useCallback (~502 tok)
...
- `useReveal.js` — Lightweight alternative to framer-motion whileInView for simple CSS-driven reveals. (~170 tok)
