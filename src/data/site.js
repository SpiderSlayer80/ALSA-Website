...
export const TEAM = [
  ...
  { name: 'Hariene',   role: 'Co-President',          group: 'Leadership', photo: 'Hariene.jpg',   accent: '#F5B800', crop: 'center top' },
  { name: 'Kalishika', role: 'Vice President',        group: 'Leadership', photo: 'Kalshika.JPG',  accent: '#F5B800', crop: 'center top' },
  { name: 'Thisas',    role: 'Secretary',             group: 'Leadership', photo: 'Thisas.jpg',    accent: '#F5B800', crop: 'center top' },
  ...
  { name: 'Mahimi',    role: 'Events Co-ordinator',   group: 'Executives', photo: 'Mahimi.JPG',    accent: '#2255cc', crop: 'center top' },
  { name: 'Ravindu',   role: 'Events Co-ordinator',   group: 'Executives', photo: 'Ravindu.jpeg',  accent: '#2255cc', crop: 'center top' },
  { name: 'Misha',     role: 'Graphic Designer',      group: 'Executives', photo: 'Misha.jpg',     accent: '#2255cc', crop: 'center' },
  { name: 'Sharon',    role: 'Graphic Designer',      group: 'Executives', photo: 'Sharon.jpeg',   accent: '#2255cc', crop: 'center' },
  { name: 'Riveen',    role: 'Treasurer',             group: 'Executives', photo: 'Riveen.JPG',    accent: '#2255cc', crop: 'center top' },
  { name: 'Shakeel',   role: 'Treasurer',             group: 'Executives', photo: 'Shakeel.jpeg',  accent: '#2255cc', crop: '5% top' },
